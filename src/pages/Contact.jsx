...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    e.preventDefault();
    //Email js changes: service id, template id, public id
      ...
      <div className='container contact__container'>
        <div className='contact__options'>
          ...
          <article className='contact__option'>
            ...
            <h5 className='contact__h5'>info@soltridge.com</h5>
            <a href='mailto:info@soltridge.com' target='_blank' className='contact__anchor'>Send a message</a>
          </article>

          <article className='contact__option'>
            <i class="ri-whatsapp-line"></i>
            <h4 className='contact__h4'>Whatsapp</h4>
            <h5 className='contact__h5'>+923262932684</h5>
            <a href='https://api.whatsapp.com/send?phone=+923262932684' target='_blank' className='contact__anchor'>Send a message</a>
          </article>
